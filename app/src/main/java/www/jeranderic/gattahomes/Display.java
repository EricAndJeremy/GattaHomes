...
public class Display extends Activity {
    ...
    private final String TAG = "Gatta Homes";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        beaconManager.setEddystoneListener(new BeaconManager.EddystoneListener() {
            ...
            public void onEddystonesFound(List<Eddystone> eddystones) {
                for (Eddystone eddystone :
                        eddystones) {
                    Log.d(TAG, "Nearby Eddystone beacon: " + eddystone.instance);
                }
                if (!eddystones.isEmpty()) {
                    updateDisplay(eddystones.get(0).instance);
                }
            }
        });
    ...
    public void updateDisplay(String beaconid) {
        ...
        for (int i = 0; i < elements.size(); i++) {
            ...
            if (elements.get(i).groupID.equals(beaconid)) {
                ...
                final String tempgroupid = elements.get(i).groupID;
    ...
    public void startVideo(String group, int id) {
        RoomElement sent = getRoomElement(group, id);
        Intent i = new Intent();
        i.setClass(this, VideoPlayer.class);
        i.putExtra("video", sent.groupID + "" + sent.id);
        startActivity(i);
    }

    public RoomElement getRoomElement(String group, int id) {
        RoomElement result;
        for (int i = 0; i < this.elements.size(); i++) {
            if (this.elements.get(i).groupID.equals(group) && this.elements.get(i).id == id) {
    ...
    public void updateBigDisplay(String groupID, int id) {
        TextView title = (TextView) findViewById(R.id.title);
        TextView description = (TextView) findViewById(R.id.description);

        for (int i = 0; i < elements.size(); i++) {
            if (elements.get(i).groupID.equals(groupID) && elements.get(i).id == id) {
